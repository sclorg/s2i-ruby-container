...
Usage
---------------------
For this, we will assume that you are using the `rhscl/ruby-23-rhel7 image`, available via `ruby:2.3` imagestream tag in Openshift.
Building a simple [ruby-sample-app](https://github.com/sclorg/s2i-ruby-container/tree/master/2.3/test/puma-test-app) application
