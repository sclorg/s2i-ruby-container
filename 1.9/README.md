...
Usage
---------------------
To build a simple [ruby-sample-app](https://github.com/openshift/sti-ruby/tree/master/1.9/test/puma-test-app) application
...
*  **For CentOS based image**
    ```
    $ s2i build https://github.com/openshift/sti-ruby.git --context-dir=1.9/test/puma-test-app/ openshift/ruby-19-centos7 ruby-sample-app
    $ docker run -p 8080:8080 ruby-sample-app
    ```
