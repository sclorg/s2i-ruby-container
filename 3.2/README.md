Ruby 3.2 container image
========================
This container image includes Ruby 3.2 as a [S2I](https://github.com/openshift/source-to-image) base image for your Ruby 3.2 applications.
...
Ruby 3.2 available as container is a base platform for
building and running various Ruby 3.2 applications and frameworks.
...
Usage in Openshift
------------------
For this, we will assume that you are using the `ubi8/ruby-32 image`, available via `ruby:3.2` imagestream tag in Openshift.
Building a simple [ruby-sample-app](https://github.com/sclorg/s2i-ruby-container/tree/master/3.2/test/puma-test-app) application
in Openshift can be achieved with the following step:

    ```
    oc new-app ruby:3.2~https://github.com/sclorg/rails-ex.git
    ```
...
```
podman pull ubi8/ruby-32
```

An RHEL8 image `ubi8/ruby-32` is used in this example.
